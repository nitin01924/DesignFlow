function CanvasArea() {
  return (
    ...
    >
      <div className="flex aspect-4/3 w-full max-w-3xl flex-col items-center justify-center border border-slate-200 bg-white p-8 text-center shadow-[0_20px_50px_rgba(15,23,42,0.10)] dark:border-slate-700 dark:bg-slate-800 dark:shadow-[0_20px_50px_rgba(0,0,0,0.30)]">
