...
function MobileEditorHeader({ projectTitle, onUpload, isUploading }) {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between gap-3 border-b border-slate-200 bg-white px-3 dark:border-slate-800 dark:bg-slate-950 md:hidden">
      ...
      <button
        ...
        className="grid size-11 shrink-0 place-items-center rounded-full bg-blue-600 text-white active:bg-blue-700 disabled:opacity-50"
